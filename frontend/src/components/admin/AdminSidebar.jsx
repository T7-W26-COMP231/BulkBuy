...
export default function AdminSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-50 w-72 border-r border-neutral-light bg-white
          transform transition-transform duration-300 ease-in-out
          ${isMobileOpen ? "translate-x-0" : "-translate-x-full"}
          lg:static lg:z-auto lg:flex lg:translate-x-0 lg:flex-col
        `}
      >
        <div className="flex items-center justify-between border-b border-neutral-light px-6 py-6 lg:block">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-lg p-2 text-text-muted hover:bg-neutral-light lg:hidden"
