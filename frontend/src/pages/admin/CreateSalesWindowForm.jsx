...
export default function CreateSalesWindowForm({ onSuccess }) {
    ...
    return (
        <>
            {/* ✅ ADD THIS — outer flex wrapper */}
            <div style={{ display: "flex", minHeight: "100vh" }}>

                {/* ✅ MOVEED AdminSidebar HERE — outside the 960 container */}
                <AdminSidebar
                    isMobileOpen={sidebarOpen}
                    onClose={() => setSidebarOpen(false)}
                />

                {/* ✅ This div wraps everything that was already in your return */}
                <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
                    ...
                    </div> {/* closes overflowY div */}
                </div> {/* closes column flex div */}
