        ...
        <aside className="min-w-0 xl:w-[38%]">
            <div className="rounded-2xl bg-white p-6 shadow-sm">
                <div className="flex flex-col gap-6">
                    ...
                    {productError ? (
                        <div className="flex flex-col items-center gap-4 rounded-2xl border border-neutral-light bg-background-light p-8 text-center">
                            <span className="material-symbols-outlined text-[48px] text-text-muted">
                                inventory_2
                            </span>
                            <div>
                                <p className="text-lg font-bold text-text-main">Product not found</p>
                                <p className="mt-1 text-sm text-text-muted">
                                    This product may have been removed or is no longer available.
                                </p>
                            </div>
                            <button type="button" onClick={onClose}
                                className="rounded-2xl bg-primary px-6 py-3 text-sm font-bold text-text-main transition hover:opacity-90">
                                Return to catalog
                            </button>
                        </div>
                    ) : (
